...
$(document).ready(function () {
    ...
    var $buythemediv = '<div class="quick-question xs-display-none"><a href="mailto:kor-evgenii@mail.ru?subject=Вопрос Елизавете"><span>Задать вопрос</span></a></div>';
    ...
    // use for simple masonry ( for example index.html page )
